    ...
    <div className="relative flex py-8 px-2 gap-10 h-full">
      <div
        ...
        <div className="flex flex-1 w-full h-full flex-col space-y-2  ">
          <img
            src="https://m.media-amazon.com/images/I/614aNUDoCxL.jpg"
            alt="header"
            width={800}
            height={800}
...
export const SkeletonThree = () => {
  return (
    <a
      href="https://youtu.be/vui4_9kqpoA?si=jEO3O1V0_b1ZcP9r"
      target="__blank"
      ...
      <div
        ...
        <div className="flex flex-1 w-full h-full flex-col space-y-2  relative">
          ...
          <img
            src="https://image.benq.com/is/image/benqco/BenQ%20WiT%20Genie_Scenario%20Photo_Gold_main?$ResponsivePreset$"
            alt="header"
            width={800}
            height={800}
...
export const SkeletonTwo = () => {
  const images = [
    "https://m.media-amazon.com/images/I/61yETuVnvzL.jpg",
    "https://m.media-amazon.com/images/I/71Xa0fzUiGL.jpg",
    "https://thedecorkart.com/cdn/shop/products/2_436f58d4-4e01-4d37-8868-33db97ae4f95.jpg?v=1748419424",
    "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcR7b12VdOqfI31Oa2-drHK8FjQU_0agz2Lk5g&s",
    "https://thepeppystore.in/cdn/shop/files/WhatsApp_Image_2024-12-10_at_12.24.27_PM.jpg?v=1733814906",
  ];
